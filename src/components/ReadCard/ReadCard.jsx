const ReadCard = ({books}) => {
    ...
    const {bookName, author, tags, publisher, totalPages, yearOfPublishing, category, rating} = books;

    return (
        <div className="card lg:card-side bg-base-100 border-2 mt-6">
            <figure className="w-1/4 p-6"><img className="rounded-2xl" src="https://daisyui.com/images/stock/photo-1494232410401-ad00d5433cfa.jpg" alt="Album" /></figure>
            <div className="card-body text-lg">
                ...
                <div className="border-b-[1px] flex gap-10 pb-4">
                    <span className="flex gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
